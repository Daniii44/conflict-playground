...
TOP100_TARGETS: tuple[TiltTarget, ...] = (
    ...
    TiltTarget("modify/delete", ConflictType.CONFLICT_MODIFY_DELETE, 350),
    TiltTarget("rename", ConflictType.CONFLICT_RENAME_DELETE, 75),
    TiltTarget("rename", ConflictType.CONFLICT_RENAME_RENAME, 75),
    TiltTarget("directory", ConflictType.CONFLICT_DIR_RENAME_SUGGESTED, 100),
